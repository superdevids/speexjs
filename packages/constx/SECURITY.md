...
Kami sangat serius dalam menangani keamanan SpeexJS. Jika Anda menemukan kerentanan keamanan, harap laporkan dengan **responsible disclosure**:

**JANGAN** melaporkan kerentanan keamanan melalui GitHub Issues publik.

**Cara melaporkan:**

1. Kirim email ke **`keamanan@SpeexJS.org`** (kode: `[SECURITY]`)
2. Sertakan informasi berikut:
   - Deskripsi kerentanan
   - Langkah-langkah reproduksi
   - Versi SpeexJS yang terpengaruh
   - Dampak potensial
...
Area berikut termasuk dalam scope keamanan SpeexJS:
...
- Aplikasi yang dibangun menggunakan SpeexJS (keamanan aplikasi adalah tanggung jawab pengembang)
...
| Kanal | Detail |
|---|---|
| Email | `keamanan@SpeexJS.org` |
| Subjek | `[SECURITY]` + deskripsi singkat |
| Enkripsi | PGP key tersedia di `https://SpeexJS.org/security/pgp` |
...
We take the security of SpeexJS seriously. If you discover a security vulnerability, please follow **responsible disclosure**:

**DO NOT** report security vulnerabilities via public GitHub Issues.

**How to report:**

1. Email us at **`keamanan@SpeexJS.org`** with subject prefix `[SECURITY]`
2. Include:
...
| PGP | Available at `https://SpeexJS.org/security/pgp` |
