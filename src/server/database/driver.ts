import { type Dialect, MysqlDialect, PostgresqlDialect, SqliteDialect } from './dialect.js'
export type { Dialect }
...
async function createSqliteDriver(config: ConnectionConfig): Promise<Driver> {
  ...
  try {
    ...
    throw new Error('SQLite driver (better-sqlite3) is not installed. Run: npm install better-sqlite3')
  }
